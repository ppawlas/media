class GasReadingsService {
    ...
    dump() {
        return this._$http({
            ...
            this._FileSaver.saveAs(res.data, 'gas-readings.csv');
        });
    }
    ...
    _getBaseUrl(id) {
        return this._AppConstants.api + '/users/' + this._Auth.current.id + '/gas-readings' + (id ? '/' + id : '')
    }
}

export default GasReadingsService;